...
import com.example.intelliwealth.core.budget.BudgetResponseDTO;
import com.example.intelliwealth.core.goal.GoalResponseDTO;
import com.example.intelliwealth.core.subscription.SubscriptionResponseDTO;
import com.example.intelliwealth.core.transaction.TransactionResponseDTO;
import com.example.intelliwealth.core.budget.BudgetService;
...
public class FinancialChatService {
    ...
    public String getPersonalizedAdvice(String userQuery) {
        ...
        List<GoalResponseDTO> goals = goalService.getAllGoal();
